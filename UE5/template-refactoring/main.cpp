...
template <unsigned int prefix,
    ...
    char               Current,
    char... Chars>
struct ISBNParser<prefix, group, registrant, publication, checksum, state, Current, Chars...>
        : public ISBNParser<
              ...
              selection<state == 2 && isDigit<Current>::value, appendDigit<registrant, Current>::value, registrant>::
                  value,
              selection<state == 3 && isDigit<Current>::value, appendDigit<publication, Current>::value, publication>::
                  value,
...
constexpr ISBN operator"" _isbn()
{
    ...
    return ISBNInstantiator<Result::Prefix, Result::Group, Result::Registrant, Result::Publication,
        Result::Checksum>::create();
}
